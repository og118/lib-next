...
async def create_transaction(create_transaction_input: CreateTransactionInput):
    print(f"Creating new transaction: {create_transaction_input}")
    user_id: int = create_transaction_input.user_id
    book_id: int = create_transaction_input.book_id
    transaction_service = TransactionService()
    print("Validating that the transaction is possible")
    is_in_stock: bool = await transaction_service.validate_book_stock(user_id, book_id)
    if not is_in_stock:
        raise Exception("Book is not in stock")
    print("Validated that the book is in stock")
    ...
    print("Validated that the transaction is possible")
...
async def get_all_transactions():
    try:
        ...
        print(f"Error while getting all transactions - {e}")
        return []
    return transactions
...
async def get_transaction(transaction_id: int):
    try:
        ...
        print(f"Error while getting transaction with id: {transaction_id} - {e}")
        return None
    return transaction
...
async def update_transaction(transaction_id: int, status: TransactionStatus):
    try:
        ...
        print(f"Error while updating transaction with id: {transaction_id} - {e}")
        return None
    return transaction
...
async def get_all_transactions_for_user(user_id: int):
    try:
        ...
        print(f"Error while getting transactions for user_id: {user_id} - {e}")
        return []
    return transactions
...
async def get_all_transactions_for_book(book_id: int):
    try:
        ...
        print(f"Error while getting transactions for book_id: {book_id} - {e}")
        return []
    return transactions
